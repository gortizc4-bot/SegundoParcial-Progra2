...
public class VentanaPrincipal extends JFrame {
    ...
    private JPanel crearEncabezado() {
        ...
        JLabel lblSubtitulo =
                new JLabel("Bienestar, belleza y momentos para ti");
    ...
    private JPanel crearTarjetaFormulario() {
        ...
        chkConfirmacionLlamada.setFont(
                new Font("SansSerif", Font.PLAIN, 12)
        );

        chkConfirmacionLlamada.setForeground(textoPrincipal);
        chkConfirmacionLlamada.setOpaque(false);
        ...
        formulario.add(chkConfirmacionLlamada, gbc);

        tarjeta.add(formulario, BorderLayout.CENTER);

        JLabel nota = new JLabel(
                "Las citas nuevas se guardan automáticamente con estado pendiente."
        );
    ...
    private JPanel crearTarjetaTabla() {
        ...
        tabla.getColumnModel().getColumn(0)
                .setCellRenderer(new RendererTabla(true));

        tabla.getColumnModel().getColumn(1)
                .setCellRenderer(new RendererTabla(false));
        ...
        tabla.getColumnModel().getColumn(4)
                .setCellRenderer(new DuracionRenderer());
    ...
    private JPanel crearPanelBotones() {
        ...
        btnGuardar = crearBoton(
                ...
                rosaPrincipal,
                Color.WHITE,
                new Color(188, 113, 146)
        );
        
        btnTotales = crearBoton(
                "Ver totales",
                Color.WHITE,
                rosaOscuro,
                rosaClaro
    ...
    private void guardarCita() {
        ...
        try {
            ...
            // Las nuevas citas siempre comienzan pendientes
            cita.setEstado("pendiente");

            cita.setConfirmacion(
                    chkConfirmacionLlamada.isSelected()
            );
    ...
    private void mostrarTotales() {
        ...
        try {
            ...
            if (citas.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(
                        ...
                        "No hay citas registradas.\n"
                                + "Total de minutos: 0\n"
                                + "Promedio de duración: 0.00 minutos",
                        "Totales",
                        JOptionPane.INFORMATION_MESSAGE
                );
            ...
            double promedio = (double) totalMinutos / citas.size();
    ...
    private void cargarDatosSeleccionados() {
        ...
        chkConfirmacionLlamada.setSelected(
                "Sí".equalsIgnoreCase(confirmacion)
        );
    ...
    private void limpiarFormulario() {
        ...
        chkConfirmacionLlamada.setSelected(false);
    ...
    private void actualizarModoEdicion(boolean editando) {
        ...
        if (editando) {
            ...
            lblModo.setText(
                    "Editando cita #" + idSeleccionado
            );

            cmbEstado.setEnabled(true);
            chkConfirmacionLlamada.setEnabled(true);
    ...
    private class DuracionRenderer
            extends RendererTabla {
